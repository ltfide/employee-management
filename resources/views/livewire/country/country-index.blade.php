                    ...
                    <tbody>
                        @forelse ($countries as $country)
                            <tr>
                                ...
                                <td>{{ $country->name }}</td>
                                <td>
                                    <button wire:click="showCountry({{ $country->id }})" class="btn btn-success">Edit</button>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="countryCode" type="text"
                            class="form-control @error('name') is-invalid @enderror" wire:model.defer="countryCode">
